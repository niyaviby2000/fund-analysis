...
urlpatterns = [
    ...
    path('expense/<int:dinner>/edit/',views.ExpenseUpdateView.as_view(),name="expense-edit"),
    ...
    path('income/<int:dinner>/change/',views.IncomeUpdateView.as_view(),name="income-edit"),
